(function () {
	...
	var Group = /** @class */ (function () {
	    ...
	    /**
	     * Destroys the entity-groups buttons, clears the internal criteria and removes it from the dom
	     */
	    Group.prototype.destroy = function () {
	        // Turn off listeners
	        $$1(this.dom.add).off('.dtsb');
	        $$1(this.dom.logic).off('.dtsb');
	        // Trigger event for entity-groups at a higher level to pick up on
	    ...
	    /**
	     * Locates the entity-groups logic button to the correct location on the page
	     */
	    ...
	    /**
	     * Sets listeners on the entity-groups elements
	     */
	    ...
	    /**
	     * Gets the count for the number of criteria in this group and any sub entity-groups
	     */
	    ...
	    Group.prototype._setCriteriaListeners = function (criteria) {
	        ...
	        $$1(criteria.dom.right)
	            ...
	            // Update the details in the current entity-groups criteria array
	        ...
	        $$1(criteria.dom.left)
	            ...
	            //  bubbling is also possible, but that is slow with deep levelled entity-groups
	            $$1(_this.s.topGroup).trigger('dtsb-redrawContents');
	            _this.s.dt.draw();
	            return false;
	        });
	    ...
	    /**
	     * Sets listeners for sub entity-groups of this group
