...
<head>
    ...
    <title>{{ config('app.name') }} - @section('title', 'Bienvenue') @yield('title')</title>
    <!-- Google font-->
        ...
        <div class="main-header-right row m-0">
            <div class="main-header-left">
                <div class="logo-wrapper"><a href="{{ route('home') }}"><img class="img-fluid"
                                                                             src="{{ asset('assets/images/logo/app-logo.png') }}"
                    ...
                    <li>
                        <form class="form-inline search-form">
                            <div class="search-bg"><i class="fa fa-search"></i>
                                <input aria-label="retrouver une commande" class="form-control-plaintext"
            ...
            <div class="nav-right col pull-right right-menu p-0">
                <ul class="nav-menus">
                    <li><a class="text-dark" href="#" onclick="toggleFullScreen()"><i data-feather="maximize"></i></a>
                    </li>
                    ...
                    <li class="onhover-dropdown p-0">
                        <button class="btn btn-primary-light" type="button">
                            <a href="#" onclick="event.preventDefault();
                                    ...
                                    data-feather="log-out"></i>Déconnexion</a></button>
