    ...
    <div class="main-navbar">
        ...
        <div id="mainnav">
            <ul class="nav-menu custom-scrollbar">
                ...
                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="home"></i><span>Tableau de bord</span></a>
                    <ul class="nav-submenu menu-content">
                        <li><a href="{{ route('home') }}">Default</a></li>
                        <li><a href="dashboard-02.html">Ecommerce</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('orders.index') }}"><i data-feather="shopping-cart"></i><span>Commandes</span></a></li>
                ...
                <li class="dropdown"><a class="nav-link menu-title link-nav" href="../starter-kit/{{ route('home') }}"><i data-feather="anchor"></i><span>Starter kit   </span></a></li>
